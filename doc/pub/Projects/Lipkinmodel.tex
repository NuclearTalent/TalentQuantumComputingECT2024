...
%% doconce format latex Lipkinmodel.do.txt --print_latex_style=trac --latex_admon=paragraph
%%
...
If you plan to write a report, you could use the article in the Physical Review C, volume 106, see \href{{https://journals.aps.org/prc/pdf/10.1103/PhysRevC.106.024319}}{\nolinkurl{https://journals.aps.org/prc/pdf/10.1103/PhysRevC.106.024319}} as a template for your report.

\subsection*{Part a) (score 10pt)}
...
Compare your code with the results obtained using for example software like \textbf{Qiskit}.

\subsection*{Part b) (score 10pt)}
